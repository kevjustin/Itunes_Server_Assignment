Designed a website that utilizes the express.js framework to receive song requests from users and return the top songs associated with the request using the itunes API.
